...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/fuel/fuel.page.html":
/*!***************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/fuel/fuel.page.html ***!
  \***************************************************************************/
...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/fuel/modal/modal.page.html":
/*!**********************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/fuel/modal/modal.page.html ***!
  \**********************************************************************************/
/*! exports provided: default */
...
/* harmony import */ var _fuel_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./fuel.page */ "./src/app/fuel/fuel.page.ts");
/* harmony import */ var _fuel_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./fuel.service */ "./src/app/fuel/fuel.service.ts");
/* harmony import */ var _service_car_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../service/car.service */ "./src/app/service/car.service.ts");
/* harmony import */ var _service_driver_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../service/driver.service */ "./src/app/service/driver.service.ts");
/* harmony import */ var _modal_modal_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modal/modal.module */ "./src/app/fuel/modal/modal.module.ts");
/* harmony import */ var _modal_modal_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modal/modal.page */ "./src/app/fuel/modal/modal.page.ts");
...
var routes = [
    {
        path: '',
        component: _fuel_page__WEBPACK_IMPORTED_MODULE_5__["FuelPage"]
    },
    {
        path: ':id',
        component: _fuel_page__WEBPACK_IMPORTED_MODULE_5__["FuelPage"]
...
var FuelPageModule = /** @class */ (function () {
    function FuelPageModule() {
    }
    FuelPageModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _modal_modal_module__WEBPACK_IMPORTED_MODULE_9__["ModalPageModule"]
            ],
            declarations: [_fuel_page__WEBPACK_IMPORTED_MODULE_5__["FuelPage"]],
            providers: [
                _fuel_service__WEBPACK_IMPORTED_MODULE_6__["FuelService"],
                _service_driver_service__WEBPACK_IMPORTED_MODULE_8__["DriverService"],
                _service_car_service__WEBPACK_IMPORTED_MODULE_7__["CarService"]
            ],
            entryComponents: [
                _modal_modal_page__WEBPACK_IMPORTED_MODULE_10__["ModalPage"]
            ]
        })
    ], FuelPageModule);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Z1ZWwvZnVlbC5wYWdlLnNjc3MifQ== */");
...
/* harmony import */ var _fuel_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./fuel.service */ "./src/app/fuel/fuel.service.ts");
...
/* harmony import */ var _modal_modal_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modal/modal.page */ "./src/app/fuel/modal/modal.page.ts");
...
var FuelPage = /** @class */ (function (_super) {
    __extends(FuelPage, _super);
    function FuelPage(_driverService, _carService, _formBuilder, _fuelService, _modalController, _route) {
        ...
        _this._fuelService = _fuelService;
        _this._modalController = _modalController;
        _this._route = _route;
        return _this;
    }
    FuelPage.prototype.ngOnInit = function () {
    ...
    FuelPage.prototype.updateForm = function () {
        var _this = this;
        var id = this._route.snapshot.paramMap.get("id");
        if (id !== null) {
            this._fuelService.get(id).subscribe(function (suc) {
    ...
    FuelPage.prototype.save = function () {
        var _this = this;
        this.form.value.date = moment__WEBPACK_IMPORTED_MODULE_5__(this.form.value.date).format("YYYY-MM-DD");
        var id = this._route.snapshot.paramMap.get("id");
        if (id === null) {
            this._fuelService.save(this.form.value).subscribe(function (suc) {
                _this.presentModal(suc);
                _this.form.reset();
            });
        }
        else {
            this._fuelService.update(id, this.form.value).subscribe(function (suc) {
                _this.presentModal(suc);
                _this.form.reset();
            });
        }
    };
    FuelPage.prototype.presentModal = function (response) {
    ...
    FuelPage.ctorParameters = function () { return [
        ...
        { type: _fuel_service__WEBPACK_IMPORTED_MODULE_4__["FuelService"] },
    ...
    FuelPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: "app-fuel",
            template: __importDefault(__webpack_require__(/*! raw-loader!./fuel.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/fuel/fuel.page.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./fuel.page.scss */ "./src/app/fuel/fuel.page.scss")).default]
        }),
        __metadata("design:paramtypes", [_service_driver_service__WEBPACK_IMPORTED_MODULE_3__["DriverService"],
            ...
            _fuel_service__WEBPACK_IMPORTED_MODULE_4__["FuelService"],
...
var FuelService = /** @class */ (function () {
    function FuelService(_httpClient) {
        this._httpClient = _httpClient;
        this.url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].baseUrl + '/api/v1/fuel';
        this.headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Content-Type', 'application/json');
    }
    FuelService.prototype.save = function (data) {
        return this._httpClient.post(this.url, data, {
            headers: this.headers
        });
    };
    FuelService.prototype.update = function (id, data) {
        return this._httpClient.put(this.url + "/" + id, data, {
            headers: this.headers
        });
    };
    FuelService.prototype.get = function (id) {
...
/***/ "./src/app/fuel/modal/modal.module.ts":
/*!********************************************!*\
  !*** ./src/app/fuel/modal/modal.module.ts ***!
  \********************************************/
...
/* harmony import */ var _modal_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modal.page */ "./src/app/fuel/modal/modal.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/***/ "./src/app/fuel/modal/modal.page.scss":
/*!********************************************!*\
  !*** ./src/app/fuel/modal/modal.page.scss ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2Z1ZWwvbW9kYWwvbW9kYWwucGFnZS5zY3NzIn0= */");

/***/ }),

/***/ "./src/app/fuel/modal/modal.page.ts":
/*!******************************************!*\
  !*** ./src/app/fuel/modal/modal.page.ts ***!
  \******************************************/
...
var ModalPage = /** @class */ (function () {
    ...
    ModalPage = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-modal',
            template: __importDefault(__webpack_require__(/*! raw-loader!./modal.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/fuel/modal/modal.page.html")).default,
            styles: [__importDefault(__webpack_require__(/*! ./modal.page.scss */ "./src/app/fuel/modal/modal.page.scss")).default]
        }),
...
//# sourceMappingURL=fuel-fuel-module.js.map