...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-item [routerLink]=\"link.url\" [class.active-item]=\"link.active\" routerDirection=\"root\">\n  <ion-icon [name]=\"link.icon\" slot=\"start\"></ion-icon>\n  <ion-label>{{link.title}}</ion-label>\n</ion-item>");
...
var map = {
	"../annual-summary/annual-summary.module": [
		"./src/app/annual-summary/annual-summary.module.ts",
		"annual-summary-annual-summary-module"
	],
	"../monthly-goal/monthly-goal.module": [
		"./src/app/monthly-goal/monthly-goal.module.ts",
		"monthly-goal-monthly-goal-module"
	],
	"../monthly-summary/monthly-summary.module": [
	...
	"./city/city.module": [
		...
		"default~city-city-module~fuel-fuel-module~monthly-monthly-module~traffic-ticket-traffic-ticket-modul~f8ec5a96",
		"common",
		"city-city-module"
	],
	...
	"./traffic-ticket/traffic-ticket.module": [
...
var routes = [
    ...
    { path: 'traffic-ticket', loadChildren: './traffic-ticket/traffic-ticket.module#TrafficTicketPageModule' },
];
...
/* harmony import */ var _menu_item_menu_item_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./menu-item/menu-item.component */ "./src/app/menu-item/menu-item.component.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _menu_item_menu_item_component__WEBPACK_IMPORTED_MODULE_9__["MenuItemComponent"]],
            entryComponents: [],
            imports: [
            ...
            providers: [
                ...
                { provide: _angular_core__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_CURRENCY_CODE"], useValue: '' }
            ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".active-item {\n  border-left: 8px solid var(--ion-color-primary);\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
var environment = {
    production: false,
    baseUrl: 'https://taxidobarba.herokuapp.com'
};
/*
...
module.exports = __webpack_require__(/*! /work/taxidobarba/frontend/src/main.ts */"./src/main.ts");
